...
image:https://maven-badges.herokuapp.com/maven-central/io.github.cuioss.test/cui-test-generator/badge.svg[Maven Central,link=https://maven-badges.herokuapp.com/maven-central/io.github.cuioss.test/cui-test-generator]
