 ...
 * In the current implementation it actually uses code derived from QuickCheck, thanks guys, but mostly the
 * generator part. These code is isolated {@link io.cui.test.generator.internal.net.java.quickcheck} and
