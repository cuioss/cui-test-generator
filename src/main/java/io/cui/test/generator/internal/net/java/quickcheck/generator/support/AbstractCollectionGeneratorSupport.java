...
abstract class AbstractCollectionGeneratorSupport<T> {
       ...
       private final IteratorGenerator<T> iteratorGenerator;

       public AbstractCollectionGeneratorSupport(Generator<T> content,
                       Generator<Integer> size) {
               this.iteratorGenerator = new IteratorGenerator<>(content, size);
       }

       protected void fill(Collection<T> collection) {
               Iterator<T> iterator = iteratorGenerator.next();
