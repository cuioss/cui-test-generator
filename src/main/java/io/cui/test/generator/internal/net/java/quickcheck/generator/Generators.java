...
import io.cui.test.generator.internal.net.java.quickcheck.generator.support.ArrayGenerator;
import io.cui.test.generator.internal.net.java.quickcheck.generator.support.ByteArrayGenerator;
import io.cui.test.generator.internal.net.java.quickcheck.generator.support.ByteGenerator;
import io.cui.test.generator.internal.net.java.quickcheck.generator.support.CharacterGenerator;
import io.cui.test.generator.internal.net.java.quickcheck.generator.support.CloningGenerator;
import io.cui.test.generator.internal.net.java.quickcheck.generator.support.DateGenerator;
import io.cui.test.generator.internal.net.java.quickcheck.generator.support.DefaultFrequencyGenerator;
import io.cui.test.generator.internal.net.java.quickcheck.generator.support.DoubleGenerator;
import io.cui.test.generator.internal.net.java.quickcheck.generator.support.DuplicateGenerator;
import io.cui.test.generator.internal.net.java.quickcheck.generator.support.EnsuredValuesGenerator;
import io.cui.test.generator.internal.net.java.quickcheck.generator.support.ExcludingGenerator;
import io.cui.test.generator.internal.net.java.quickcheck.generator.support.FixedValuesGenerator;
import io.cui.test.generator.internal.net.java.quickcheck.generator.support.IntegerArrayGenerator;
import io.cui.test.generator.internal.net.java.quickcheck.generator.support.IntegerGenerator;
import io.cui.test.generator.internal.net.java.quickcheck.generator.support.IteratorGenerator;
import io.cui.test.generator.internal.net.java.quickcheck.generator.support.ListGenerator;
import io.cui.test.generator.internal.net.java.quickcheck.generator.support.LongGenerator;
import io.cui.test.generator.internal.net.java.quickcheck.generator.support.MapGenerator;
import io.cui.test.generator.internal.net.java.quickcheck.generator.support.ObjectDefaultMappingGenerator;
import io.cui.test.generator.internal.net.java.quickcheck.generator.support.ObjectGeneratorImpl;
import io.cui.test.generator.internal.net.java.quickcheck.generator.support.SetGenerator;
import io.cui.test.generator.internal.net.java.quickcheck.generator.support.SortedListGenerator;
import io.cui.test.generator.internal.net.java.quickcheck.generator.support.StrictlyOrderedGenerator;
import io.cui.test.generator.internal.net.java.quickcheck.generator.support.StringGenerator;
import io.cui.test.generator.internal.net.java.quickcheck.generator.support.SubmapGenerator;
import io.cui.test.generator.internal.net.java.quickcheck.generator.support.SubsetGenerator;
import io.cui.test.generator.internal.net.java.quickcheck.generator.support.SubstringGenerator;
import io.cui.test.generator.internal.net.java.quickcheck.generator.support.TupleGenerator;
...
public  class Generators {
    ...
    /**
     * Create a new string generator which creates strings of characters
     * generated by {@link Generators#basicLatinCharacters()} and
    ...
    /**
     * Create a new integer generator which creates integers ranging from {@code lo} to
     * {@code hi} based on the given {@link Distribution}.
     */
    ...
    /**
     * Create a new integer generator which creates integers ranging from {@code 1} to
    ...
    /**
     * Create a new integer generator which creates integers ranging from {@code 1} to
     * {@code max} (which must be at least 1).
     */
     ...
     * {@link Generators#frequency(Generator, int)} when all generator
     ...
     *            {@link Generators#DEFAULT_COLLECTION_MAX_SIZE} then it
    ...
    public static <T> Generator<List<T>> strictlyOrdered(Generator<T> input,
        ...
        return strictlyOrdered(input, comparator, new IntegerGenerator(0,
