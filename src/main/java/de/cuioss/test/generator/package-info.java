 ...
 * mostly the
 * generator part. These code is isolated {@link de.cuioss.test.generator.internal.net.java.quickcheck}
 * and
 * will be replaced in the future. Therefore: Do not use any of that code at all!
 * Central elements are:
 * <ul>
 * <li>{@link de.cuioss.test.generator.TypedGenerator}: Is the core Type. Instances of it are used
 * for generating arbitrary instances of any value-object. Compared to
 * {@link de.cuioss.test.generator.internal.net.java.quickcheck.Generator} it provides an additional
 * method providing runtime information on the type being generated:
 * {@link de.cuioss.test.generator.TypedGenerator#getType()}.</li>
 * <li>{@link de.cuioss.test.generator.Generators}: Factory methods for accessing
 * {@link de.cuioss.test.generator.TypedGenerator} for many java-lang types.</li>
 * <li>{@link de.cuioss.test.generator.domain}: Provides some domain specific
 * {@link de.cuioss.test.generator.TypedGenerator}
 * </li>
 * </ul>
 */
