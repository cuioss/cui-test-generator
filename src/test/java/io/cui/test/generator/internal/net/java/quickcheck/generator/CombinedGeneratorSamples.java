...
public class CombinedGeneratorSamples {
     ...
     */
    public static <A, B, C> io.cui.test.generator.internal.net.java.quickcheck.collection.Triple<A, B, C> anyTriple(
            io.cui.test.generator.internal.net.java.quickcheck.Generator<A> first,
            io.cui.test.generator.internal.net.java.quickcheck.Generator<B> second,
            io.cui.test.generator.internal.net.java.quickcheck.Generator<C> third) {
     ...
     * See documentation of {@link CombinedGenerators#intArrays}.
     */
    public static int[] anyIntArray(io.cui.test.generator.internal.net.java.quickcheck.Generator<Integer> content,
            io.cui.test.generator.internal.net.java.quickcheck.Generator<Integer> size) {
     ...
     */
    public static <T> T anyEnsureValue(Iterable<T> ensuredValues,
            io.cui.test.generator.internal.net.java.quickcheck.Generator<T> otherValues) {
     ...
     */
    public static <A, B> io.cui.test.generator.internal.net.java.quickcheck.collection.Pair<A, B> anyPair(
            io.cui.test.generator.internal.net.java.quickcheck.Generator<A> first,
            io.cui.test.generator.internal.net.java.quickcheck.Generator<B> second) {
     ...
     */
    public static <T> T anyFrequency(io.cui.test.generator.internal.net.java.quickcheck.Generator<T> generator,
            int weight) {
    ...
    public static <K, V> java.util.Map<K, V> anyMap(
            io.cui.test.generator.internal.net.java.quickcheck.Generator<K> keys,
            io.cui.test.generator.internal.net.java.quickcheck.Generator<V> values) {
    ...
    public static <K, V> java.util.Map<K, V> anyMap(java.util.Map<K, V> supermap,
            io.cui.test.generator.internal.net.java.quickcheck.Generator<Integer> sizes) {
    ...
    public static <T extends Comparable<T>> java.util.List<T> anySortedList(
            io.cui.test.generator.internal.net.java.quickcheck.Generator<T> content) {
     ...
     */
    public static <T extends Comparable<T>> java.util.List<T> anySortedList(
            io.cui.test.generator.internal.net.java.quickcheck.Generator<T> content, int low, int high) {
    ...
    public static <T> java.util.List<T> anyVector(
            io.cui.test.generator.internal.net.java.quickcheck.Generator<T> content, int size) {
     ...
     */
    public static <T extends Comparable<T>> io.cui.test.generator.internal.net.java.quickcheck.collection.Pair<T, T> anySortedPair(
            io.cui.test.generator.internal.net.java.quickcheck.Generator<T> content) {
     ...
     */
    public static <T extends Comparable<T>> io.cui.test.generator.internal.net.java.quickcheck.collection.Triple<T, T, T> anySortedTriple(
            io.cui.test.generator.internal.net.java.quickcheck.Generator<T> content) {
     ...
     */
    public static <T> T[] anyArray(io.cui.test.generator.internal.net.java.quickcheck.Generator<? extends T> content,
            Class<T> type) {
     ...
     */
    public static <T> T[] anyArray(io.cui.test.generator.internal.net.java.quickcheck.Generator<? extends T> content,
            io.cui.test.generator.internal.net.java.quickcheck.Generator<Integer> size, Class<T> type) {
    ...
    public static <T> T[] anyNonEmptyArray(
            io.cui.test.generator.internal.net.java.quickcheck.Generator<? extends T> content, Class<T> type) {
     ...
     * See documentation of {@link CombinedGenerators#byteArrays}.
     */
    public static byte[] anyByteArray(io.cui.test.generator.internal.net.java.quickcheck.Generator<Byte> content,
            io.cui.test.generator.internal.net.java.quickcheck.Generator<Integer> size) {
     ...
     */
    @SafeVarargs
    public static <T> T anyExcludeValue(io.cui.test.generator.internal.net.java.quickcheck.Generator<T> generator,
            T... excluded) {
    ...
    public static <T extends Comparable<T>> java.util.List<T> anyStrictlyOrdered(
            io.cui.test.generator.internal.net.java.quickcheck.Generator<T> input) {
     ...
     */
    public static <T extends Comparable<T>> java.util.List<T> anyStrictlyOrdered(
            io.cui.test.generator.internal.net.java.quickcheck.Generator<T> input, int low, int high) {
    ...
    public static <T> java.util.List<T> anyStrictlyOrdered(
            io.cui.test.generator.internal.net.java.quickcheck.Generator<T> input, java.util.Comparator<T> comparator) {
